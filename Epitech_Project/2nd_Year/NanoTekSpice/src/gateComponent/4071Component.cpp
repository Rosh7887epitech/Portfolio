...
namespace nts {
    ...
    FourOrComponent::FourOrComponent() : ACircuit("4071")
    {
        std::shared_ptr<nts::IComponent> gate1 = nts::Factory().createComponent("or");
        std::shared_ptr<nts::IComponent> gate2 = nts::Factory().createComponent("or");
        std::shared_ptr<nts::IComponent> gate3 = nts::Factory().createComponent("or");
        std::shared_ptr<nts::IComponent> gate4 = nts::Factory().createComponent("or");
    ...
    void FourOrComponent::simulate(std::size_t tick)
    {
    ...
    nts::state FourOrComponent::compute(size_t pin)
    {
