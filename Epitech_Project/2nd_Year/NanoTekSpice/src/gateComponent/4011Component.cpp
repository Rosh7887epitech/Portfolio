...
namespace nts {
    ...
    FourNandComponent::FourNandComponent() : ACircuit("4011")
    {
        std::shared_ptr<nts::IComponent> gate1 = nts::Factory().createComponent("nand");
        std::shared_ptr<nts::IComponent> gate2 = nts::Factory().createComponent("nand");
        std::shared_ptr<nts::IComponent> gate3 = nts::Factory().createComponent("nand");
        std::shared_ptr<nts::IComponent> gate4 = nts::Factory().createComponent("nand");
    ...
    void FourNandComponent::simulate(std::size_t tick)
    {
    ...
    nts::state FourNandComponent::compute(size_t pin)
    {
