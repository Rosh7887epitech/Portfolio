...
namespace nts {
    ...
    FourAndComponent::FourAndComponent() : ACircuit("4081")
    {
        std::shared_ptr<nts::IComponent> gate1 = nts::Factory().createComponent("and");
        std::shared_ptr<nts::IComponent> gate2 = nts::Factory().createComponent("and");
        std::shared_ptr<nts::IComponent> gate3 = nts::Factory().createComponent("and");
        std::shared_ptr<nts::IComponent> gate4 = nts::Factory().createComponent("and");
    ...
    void FourAndComponent::simulate(std::size_t tick)
    {
    ...
    nts::state FourAndComponent::compute(size_t pin)
    {
