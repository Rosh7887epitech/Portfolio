...
Test(OrComponent, testOrComponent)
{
    ...
    std::shared_ptr<nts::IComponent> gate = nts::Factory().createComponent("or");
...
Test(OrComponet, testOrComponet_2_false)
{
    std::shared_ptr<nts::IComponent> input1 = nts::Factory().createComponent("false");
...
Test(OrComponet, testOrComponet_2_true)
{
...
Test(OrComponet, testOrComponet_1_Undefined_1_True)
{
    std::shared_ptr<nts::IComponent> input1 = nts::Factory().createComponent("true");
    std::shared_ptr<nts::IComponent> gate = nts::Factory().createComponent("or");
    std::shared_ptr<nts::IComponent> out = nts::Factory().createComponent("output");
...
Test(OrComponet, testOrComponet_1_Undefined_1_False)
{
    std::shared_ptr<nts::IComponent> input1 = nts::Factory().createComponent("false");
    std::shared_ptr<nts::IComponent> gate = nts::Factory().createComponent("or");
    std::shared_ptr<nts::IComponent> out = nts::Factory().createComponent("output");
