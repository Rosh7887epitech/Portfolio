...
namespace RayTracer {
  ...
  public:
    /**
     * @brief Constructs an ambient light with a color and intensity.
    ...
    /**
     * @brief Gets the direction to a point (not applicable for ambient light).
     * @param point The point to calculate the direction to.
     * @return A zero vector as ambient light has no direction.
     */
    Math::Vector3D getDirectionTo(const Math::Point3D& point) const override;

    /**
     * @brief Gets the distance to a point (not applicable for ambient light).
     * @param point The point to calculate the distance to.
     * @return Zero as ambient light has no distance.
     */
    double getDistanceTo(const Math::Point3D& point) const override;

    /**
     * @brief Gets the type of the light.
     * @return The type of the light (AMBIENT).
     */
